# 메모리 이슈 : 서버에서 돌리고,,,,,, 확인은 디버깅하면 될듯.
import argparse

ROOT = '/home/yeonghwa/workspace/reviewgraph/final_cd/'
dataset_category = "Tools_5"
BETA =0.3 # BETA = [0.3, 0.6, 1.0, 1.4]
def get_parser():
    parser = argparse.ArgumentParser(description='model parameters')
    # data
    parser.add_argument(
        '--word2vec', default=ROOT+'BERT-Whitening/bert-base-uncased_sentence_vectors_dim_64.pkl')
    parser.add_argument('--category', default=dataset_category)
    parser.add_argument('--dir', default=ROOT+'dataset/%s')
    ...
    parser.add_argument('--checkpoint', default=ROOT+'ckpt/', type=str)
    ...
    parser.add_argument('--beta', default=BETA, type=float) ##### lambda
